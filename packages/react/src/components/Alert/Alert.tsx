  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {title && (
            <p className="font-bold text-colors-neutral-800 text-sm mr-1 items-start">
              {title}
            </p>
          )}
          {children && (
            <p className="mr-2 text-colors-neutral-800 ">{children}</p>
          )}
          {link && (
            <>
              <a
        ...
        >
          <X size={16} className="text-colors-neutral-700 " />
        </button>
      </div>
    </Transition>
  );
